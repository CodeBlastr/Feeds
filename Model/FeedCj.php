...
class AppFeedCj extends FeedsAppModel {
	...
	public $categories = array("Mens Men's" => "Men's", "Womens Women's" => "Women's", );
	...
	public $fieldmap = array('name' => 'name', 'description' => 'description', 'advertiser_name' => 'advertiser-name', 'advertiser_id' => 'advertiser-id', 'category' => 'advertiser-category', 'image_url' => 'image-url', 'manufacturer_name' => 'manufacturer-name', 'manufacturer_idenifier' => 'manufacturer-sku', 'upc' => 'upc', 'isbn' => 'isbn', 'retail_price' => 'retail-price', 'price' => 'price', 'sale_price' => 'sale-price', 'currency' => 'currency', 'buy_url' => 'buy-url', 'product_id' => 'id');
